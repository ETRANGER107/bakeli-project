...
function LandingPage(props) {
  return (
    <>
      <div className="container-fluid d-flex flex-row h-100 justify-content-around"  style={{ backgroundImage: `url(${afr})`, backgroundRepeat: 'no-repeat', minHeight: "100vh", width: "auto"}}>
